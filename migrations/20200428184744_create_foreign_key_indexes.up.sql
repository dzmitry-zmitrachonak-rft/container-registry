...
CREATE INDEX IF NOT EXISTS ix_manifest_list_manifests_parent_id ON manifest_list_manifests (parent_id);
CREATE INDEX IF NOT EXISTS ix_manifest_list_manifests_child_id ON manifest_list_manifests (child_id);
