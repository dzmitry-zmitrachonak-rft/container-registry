	...
	m := &Migration{
		Migration: &migrate.Migration{
			...
			Up: []string{
				...
				"CREATE INDEX IF NOT EXISTS index_gc_blobs_layers_on_dgst_and_nmspc_id_and_rpstry_id_lyr_id ON gc_blobs_layers USING btree (digest, namespace_id, repository_id, layer_id)",
			},
			Down: []string{
				"DROP INDEX IF EXISTS index_gc_blobs_layers_on_dgst_and_nmspc_id_and_rpstry_id_lyr_id CASCADE",
