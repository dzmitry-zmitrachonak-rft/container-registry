	...
	m := &migrate.Migration{
		...
		Up: []string{
			`CREATE TABLE IF NOT EXISTS public.layers (
				...
				CONSTRAINT fk_layers_repository_id_manifest_id_manifests FOREIGN KEY (repository_id, manifest_id) REFERENCES public.manifests (repository_id, id) ON DELETE CASCADE,
		...
		Down: []string{
			"DROP INDEX IF EXISTS public.ix_layers_digest CASCADE",
			"DROP INDEX IF EXISTS public.ix_layers_manifest_id CASCADE",
