	...
	m := &Migration{
		Migration: &migrate.Migration{
			...
			Up: []string{
				...
				"CREATE INDEX IF NOT EXISTS index_layers_on_top_lvl_nmspc_id_and_rpstory_id_and_manifest_id ON layers USING btree (top_level_namespace_id, repository_id, manifest_id)",
			...
			Down: []string{
				...
				"DROP INDEX IF EXISTS index_layers_on_top_lvl_nmspc_id_and_rpstory_id_and_manifest_id CASCADE",
