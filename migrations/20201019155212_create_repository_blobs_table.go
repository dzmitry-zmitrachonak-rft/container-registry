...
func init() {
	m := &migrate.Migration{
		...
		Up: []string{
			...
			"CREATE INDEX IF NOT EXISTS ix_repository_blobs_repository_id ON repository_blobs USING btree (repository_id)",
			"CREATE INDEX IF NOT EXISTS ix_repository_blobs_blob_digest ON repository_blobs USING btree (blob_digest)",
		},
		Down: []string{
