...
// as follows:
//
// 	INFO[0001] this will be the log message  trace.duration=1.004575763s trace.func=gitlab.com/gitlab-org/container-registry/context.traceOperation trace.id=<id> ...
//
