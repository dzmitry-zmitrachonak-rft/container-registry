...
CREATE INDEX index_repository_blobs_on_repository_id ON repository_blobs USING btree (repository_id);
...
CREATE INDEX index_manifests_on_repository_id ON manifests USING btree (repository_id);
...
CREATE INDEX index_manifest_references_on_repository_id_and_parent_id ON manifest_references USING btree (repository_id, parent_id);

CREATE INDEX index_manifest_references_on_repository_id_and_child_id ON manifest_references USING btree (repository_id, child_id);
...
CREATE INDEX index_layers_on_repository_id_and_manifest_id ON layers USING btree (repository_id, manifest_id);
...
CREATE INDEX index_tags_on_repository_id_and_manifest_id ON tags USING btree (repository_id, manifest_id);
...
CREATE INDEX index_gc_blobs_layers_on_repository_id_and_layer_id ON gc_blobs_layers USING btree (repository_id, layer_id);

CREATE INDEX index_gc_blobs_layers_on_digest ON gc_blobs_layers USING btree (digest);
...
CREATE INDEX index_gc_blobs_configurations_on_repository_id_and_manifest_id ON gc_blobs_configurations USING btree (repository_id, manifest_id);

CREATE INDEX index_gc_blobs_configurations_on_digest ON gc_blobs_configurations USING btree (digest);
...
CREATE INDEX index_gc_manifest_review_queue_on_repository_id_and_manifest_id ON gc_manifest_review_queue USING btree (repository_id, manifest_id);
